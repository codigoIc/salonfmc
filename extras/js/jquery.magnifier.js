...
jQuery.imageMagnifier={
	dsettings: {
		...
		imgopacity: 0.8 //opacify of original image when enlarged image overlays it
 	},
	cursorcss: 'url(./images/agranda.cur), -moz-zoom-in', //Value for CSS's 'cursor' attribute, added to original image
	cursorcss2: 'url(./images/achica.cur), -moz-zoom-out', //Value for CSS's 'cursor' attribute, added to original image
	zIndexcounter: 100,
	imgshells: [],
	...
	magnify:function($, $target, options){
		...
		var $clone=$target.clone().css({position:'absolute', left:0, top:0, visibility:'hidden', border:'0px solid gray', cursor:jQuery.imageMagnifier.cursorcss2}).appendTo(document.body)
