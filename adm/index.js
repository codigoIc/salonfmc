...
function fn_mostrar_frm_agregar(ide_per){
	$("#div_oculto").load("ajax_form_agregar.php", {ide_per: ide_per},  function(){
		$.blockUI({
			message: $('#div_oculto'),
			css:{
				left: '1%'	,top: '1%'	
...
function fn_mostrar_texto(ide_per){
	$("#div_oculto").load("ajax_form_texto.php", {ide_per: ide_per}, function(){
		$.blockUI({
			message: $('#div_oculto'),
			css:{
				left: '1%'	,top: '1%'	
