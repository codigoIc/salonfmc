...
?>
			...
			<img src="<?echo "../".$row['fotografia1']?>" alt="<?echo $row['nombre']?>" height="50"/>
								</a>
								<div class="caption">
									<div class="image-title"><?echo $row['titulo'] ?></div>
									<div class="image-desc"><?echo $row['procedimiento'] ?></div>
									<?if ($row['nombre']!=' '){?>
									<div class="image-desc"><?echo "Autor : ".$row['nombre'] ?></div>
									<?}?>
